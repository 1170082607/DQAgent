"""Command-line entry point for the credential-free Phase 8 memory evaluation."""
...
DEFAULT_SUITE = Path("evaluations/cases/phase-8-memory-v1.json")


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Evaluate DQAgent long-term memory without credentials."
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        suite = load_memory_evaluation_suite(args.suite)
