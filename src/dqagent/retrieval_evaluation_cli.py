...
DEFAULT_SUITE = Path("evaluations/cases/phase-7-retrieval-v1.json")


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate DQAgent retrieval quality.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        report = RetrievalEvaluationRunner().run(load_retrieval_evaluation_suite(args.suite))
